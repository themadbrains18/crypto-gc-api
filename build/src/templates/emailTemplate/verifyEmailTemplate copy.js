...
const verifyEmail = function (otp) {
    const html = `
    <!DOCTYPE html>
        ...
        <table style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; width: 100%;" width="100%"
          ...
          <tr>
            <td align="center"
              ...
              <table class="sm-w-full" style="font-family: 'Montserrat',Arial,sans-serif; 
                cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                      ...
                      <tr>
                        <td class="sm-px-24"
                          style="--bg-opacity: 1; background-color: #ffffff;  border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;"
                           align="left">
                          <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Verify your email,Your verification code will be valid for 5 minutes.</p>

                          <p style="margin: 0 0 24px;">
                            You're signing up with your email account.
                          </p>
                          ...
                          <p style="margin: 0 0 16px;">
                            *Don't forward this email or verification code to anyone. <br />


                            Needing some additional support? Please contact us at
                            <a href="mailto:${process.env.SUPPORT_EMAIL}" class="hover-underline"
                              style="--text-opacity: 1; color: #7367f0;  text-decoration: none;">${process.env.SUPPORT_EMAIL}</a>.
                          </p>
