...
const TwoFactorEmailTemplate = function () {
    const html = `
    <!DOCTYPE html>
    <html
      lang="en"
                                  ...
                                  >
                                    ...
                                    <div>
                                            <span style="font-size: 14px; color:#222a35"
                                              >Your two-factor authentication on Crypto Planet has been successfully enabled.</span
                                            >
                                          </div>
                                          ...
                                          <div>
                                            <span style="font-size: 14px; color:#222a35"
                                              >
                                              This additional layer of security enhances the protection of your account. 
                                              </span
                                            >
                                          </div>
...
exports.default = TwoFactorEmailTemplate;
