...
const kycProcess = function (status) {
    const html = `
    <!DOCTYPE html>
    <html
      lang="en"
                                  ...
                                  >
                                    ...
                                    <div>
                                          ...
                                          <div>
                                            <span style="font-size: 14px; color:#222a35"
                                              >
                                              ${status === "Pending" ? "We appreciate your patience. You will be notified once the process is completed." : status === "Rejected" ? "Rejection Reason: Due to poor quality of documents" : "You are now ready to enjoy all the benefits of our platform."}
                                              </span
                                            >
                                          </div>
