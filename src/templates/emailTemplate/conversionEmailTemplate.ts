const conversionEmailTemplate = function ( converted:string,received: string ,conversionRate: string ,fees:string) {
    const html = `
    <!DOCTYPE html>
    <html
      lang="en"
                                      ...
                                      >
                                        <div style="margin-bottom: 10px">
                                          <span
                                            ...
                                            >>We are pleased to inform you that your currency conversion request has been successfully processed.</span
                                          >
                                        </div>
                                        <div style="margin-bottom: 10px">
                                          <span
                                            style="font-size: 14px; color: #222a35"
                                            ><strong>From Currency:</strong> ${converted} 
                                          </span>
                                        </div>
                                        <div style="margin-bottom: 10px">
                                          <span
                                            style="font-size: 14px; color: #222a35"
                                            <strong>To Currency:</strong> ${received}
                                          </span>
                                        </div>
                                        <div style="margin-bottom: 10px">
                                          <span
                                        ...
                                        <div style="margin-bottom: 10px">
                                          <span
                                            style="font-size: 14px; color: #222a35"
                                            ><strong>Converted Amount:</strong> ${fees}
                                          </span>
                                        </div>
                                        ...
                                        <div style="margin-top: 40px">
                                          <span
                                            style="font-size: 14px; color: #222a35"
                                            >Thank you for using our currency conversion service. If you have any questions or concerns, please feel free to contact our support team.<a
...
export default conversionEmailTemplate;