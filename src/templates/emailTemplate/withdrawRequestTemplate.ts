const withdrawEmail = function (otp : string | number, address:string, amount:string | number) {
    const html = `
    <!DOCTYPE html>
    <html
      lang="en"
                                      ...
                                      >
                                        <div style="margin-bottom: 30px">
                                          <span
                                            ...
                                            >You've created a withdrawal request.
                                            Your withdrawal information is as
                                            follows：</span
                                          >
                                        </div>
                                        ...
                                        <div style="margin-top: 40px">
                                          ...
                                          <span style="font-size: 14px; color:#222a35;"
                                              >The verification code is valid for 5 minutes.</span>
    <br/>
                                          <span style="font-size: 14px; color:#222a35;">    For the security of your account, please do not disclose the following verification code to anyone, including Crypto Planet staff.</span>
