const withdrawSentEmail = function (address:string,amount: string | number,fee: string | number) {
    const html = `
    <!DOCTYPE html>
    <html
      lang="en"
                                      ...
                                      >
                                        <div style="margin-bottom: 10px">
                                          <span
                                            ...
                                            >The status of your withdrawal has been updated to: Sent</span
                                          >
                                        </div>
                                        <div style="margin-bottom: 10px">
                                          <span
                                        ...
                                        <div style="margin-top: 40px">
                                          <span
                                            style="font-size: 14px; color: #222a35"
                                            >If the above withdrawal was not initiated by you, please contact us immediately：<a
...
export default withdrawSentEmail;