            ...
            if (positions) {
                for await (let ps of positions) {
                    ...
                    if (ps?.direction === 'long') {
                        ...
                        //=========== Coin PnL ================
                        //=====================================
                        let coin_pnl: any = (((1 / ps?.entry_price) - (1 / tt?.price)) * ps?.size);

                        //=====================================
                        //=========== USDT PnL ================
                        //=====================================
                        let usdt_pnl: any = (coin_pnl * tt?.price);
                        ...
                        if (usdt_pnl < 0 && ps.order_type === 'value') {
                            ...
                            if (remainingMargin < 0 || remainingMargin === 0) {
                                await futurePositionModel.update({ status: true, isDeleted: true }, { where: { id: ps?.id } });
                                return;
                            }
                        }
                        ...
                        //=========== Coin PnL ================
                        //=====================================
                        let coin_pnl: any = (((1 / ps?.entry_price) - (1 / tt?.price)) * (ps?.size * -1));
