...
(async function (): Promise<void> {
  try {
    ...
    if (!isAlter) {
      ...
      userModel.hasMany(orderModel, {as:'sellerOrder', foreignKey: 'sell_user_id' });
      userModel.hasMany(orderModel, {as:'buyerOrder', foreignKey: 'buy_user_id' });

      // In your order model file
      orderModel.belongsTo(userModel, {as:'seller', foreignKey: 'sell_user_id'});
      orderModel.belongsTo(userModel, {as:'buyer', foreignKey: 'buy_user_id' });
